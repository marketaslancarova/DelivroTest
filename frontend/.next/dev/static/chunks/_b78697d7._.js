...
function UploadInvoicesDialog({ onUploaded }) {
        ...
        try {
            ...
            const rows = arr.map((item, index)=>{
                ...
                return {
                    ...
                    invoicedPrice: Number(item.invoicedPrice ?? 0),
                    invoicedWeight: item.invoicedWeight !== undefined ? Number(item.invoicedWeight) : null
                };
            });
            setPreviewRows(rows);
        } catch (err) {
    ...
    const handleConfirmUpload = async ()=>{
        ...
        try {
            ...
            await res.json(); // kdybychom chtěli, můžeme použít data z odpovědi
            handleClose();
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        filteredShipments.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ShipmentCard, {
...
//# sourceMappingURL=_b78697d7._.js.map