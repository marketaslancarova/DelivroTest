            ...
            const load = {
                "ShipmentHistoryDialog.useEffect.load": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        const res = await fetch(`${BACKEND_URL}/api/shipments/${shipment.id}/history`);
                        if (!res.ok) {
...
_s(ShipmentHistoryDialog, "zCJEZ8SYbCC0YUftRRhdXmwzfno=");
...
//# sourceMappingURL=frontend_47b16b8f._.js.map