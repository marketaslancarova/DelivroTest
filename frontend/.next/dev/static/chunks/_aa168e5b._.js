...
function ShipmentHistoryDialog({ open, onOpenChange, shipment }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShipmentHistoryDialog.useEffect": ()=>{
            ...
            const loadHistory = {
                "ShipmentHistoryDialog.useEffect.loadHistory": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_URL"]}/api/shipments/${shipment.id}/history`);
                        if (!res.ok) {
                            throw new Error(`Failed to fetch history: ${res.status}`);
                        }
                        const data = await res.json();
                        const normalized = data.history.map({
                            "ShipmentHistoryDialog.useEffect.loadHistory.normalized": (h)=>({
                                    id: h.id,
                                    price: typeof h.price === "string" ? Number(h.price) : h.price,
                                    weight: h.weight,
                                    uploadedAt: h.uploadedAt
                                })
                        }["ShipmentHistoryDialog.useEffect.loadHistory.normalized"]);
                        setItems(normalized);
                    } catch (err) {
                        console.error(err);
                        setError(t("shipmentHistory.error"));
                    } finally{
                        setLoading(false);
                    }
                }
            }["ShipmentHistoryDialog.useEffect.loadHistory"];
            loadHistory();
        }
    }["ShipmentHistoryDialog.useEffect"], [
        open,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
        ...
        onOpenChange: (next)=>{
            if (!next) {
                // při zavření smažeme data, ať nezůstávají stará
                setItems([]);
                setError(null);
            }
            onOpenChange(next);
...
_s(ShipmentHistoryDialog, "flEpXVtwmPME9J+6oEx88W/TgIk=", false, function() {
    return [
...
//# sourceMappingURL=_aa168e5b._.js.map