...
function UploadInvoicesDialog({ onUploaded }) {
    ...
    const addFiles = async (filesToAdd)=>{
        ...
        try {
            ...
            const uniqueFiles = filesToAdd.filter((file)=>{
                const key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildFileKey"])(file);
                return !existingKeys.has(key);
            });
            const newlyParsed = [];
            for (const file of uniqueFiles){
                try {
                    const { rows, records } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseInvoiceFile"])(file);
                    newlyParsed.push({
                        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildFileKey"])(file),
                        file,
                        rows,
                        records,
                        expanded: false
    ...
    const handleDrop = async (e)=>{
        e.preventDefault();
        setIsDragging(false);
        const jsonFiles = Array.from(e.dataTransfer.files).filter(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isJsonFile"]);
...
//# sourceMappingURL=_4a5c8c54._.js.map