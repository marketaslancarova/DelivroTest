    ...
    const addFiles = async (filesToAdd)=>{
        ...
        try {
            ...
            const uniqueFiles = filesToAdd.filter((file)=>{
                const key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildFileKey"])(file.name);
                return !existingKeys.has(key);
            });
            const newlyParsed = [];
            for (const file of uniqueFiles){
                try {
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseInvoiceFile"])(file);
                    if (!result) {
                    ...
                    newlyParsed.push({
                        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$invoices$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildFileKey"])(file.name),
                        file,
                        rows,
                        records,
                        expanded: false
...
//# sourceMappingURL=_d9af6f2a._.js.map